...
public class SpeedTest {
    ...
    final List<EvaluationConfig> configs = new ArrayList<EvaluationConfig>();
    ...
    public static class Outputter {
        ...
        public void printOutput(SpeedTest st,String eqn, String varNames[],long[] times) {
        ...
        public void printOutput(SpeedTest st,String eqns[], String varNames[],long[] times) {
            out.print("\nTesting speed for ");
        ...
        public void printFooter(SpeedTest st,long[] totalTimes) {
            ...
            out.println("======= Totals =======");
            for(int i=0;i<st.configs.size();++i) {
                out.println(st.configs.get(i).name+"\t"+totalTimes[i]);
            }
    ...
    public static class RatioOutputter extends Outputter {
        @Override
        public void printOutput(SpeedTest st,String eqn, String varNames[],long[] times) {
            super.printOutput(st,eqn,varNames,times);
            printRatios(st,times);
        }
        @Override
        public void printOutput(SpeedTest st,String eqns[], String varNames[],long[] times) {
            super.printOutput(st, eqns, varNames, times);
            printRatios(st,times);
        }
        @Override
        public void printFooter(SpeedTest st, long[] totalTimes) {
    ...
    public void doAll(String eqn, String varNames[]) {
        ...
        outputter.printOutput(this,eqn, varNames, times);
    ...
    public void doAll(String eqns[], String varNames[]) {
        ...
        outputter.printOutput(this,eqns, varNames, times);
        //		Runtime rt = Runtime.getRuntime();
        //		out.format("free %d max %d total %d%n",rt.freeMemory(),rt.maxMemory(),rt.totalMemory());
    }
    ...
    public static class OldConfig extends EvaluationConfig {
        ...
        @Override
        public String description() {
            return "Standard Jep with FastEvaluator";
        }
    }
    ...
    public static String hornerExpression(String varName,int nDeriv) {
    ...
    public static void runTests(SpeedTest st) {
        ...
        // Big decimal components do not include trig functions, so leave this out for now
        // (causes run time errors and inaccurate results if included)
